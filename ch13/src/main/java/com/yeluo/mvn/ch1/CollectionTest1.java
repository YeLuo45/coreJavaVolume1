...
public class CollectionTest1 {
	 ...
	 */
	private static void collectionMethodTest() {
		...
		//toString方法由AbstractCollection抽象类重写
		/*  AbstractCollection抽象类的toString方法源码:
		...
		//contains(Object o)
		result=coll.contains(1);
		System.out.println(result);  //true
		
		//containsAll(Collection<?> c) 
		result=coll.containsAll(coll1);
		System.out.println(result);  //true
		
		ArrayList<Integer> a=(ArrayList<Integer>) coll;
		a.remove(-1);
	}
}
