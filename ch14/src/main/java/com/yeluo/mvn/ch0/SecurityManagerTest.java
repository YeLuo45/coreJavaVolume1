...
public class SecurityManagerTest {
    ...
    private static ThreadGroupTest rootGroup = getRootGroup();

    private static ThreadGroupTest getRootGroup() {
        ThreadGroupTest root =  ThreadTest.currentThread().getThreadGroup();
     ...
     * @see        #checkPermission(java.security.Permission) checkPermission
     */
    public void checkAccess(ThreadTest t) {
        if (t == null) {
     ...
     * @see        #checkPermission(java.security.Permission) checkPermission
     */
    public void checkAccess(ThreadGroupTest g) {
        if (g == null) {
     ...
     */
    public ThreadGroupTest getThreadGroup() {
        return ThreadTest.currentThread().getThreadGroup();
    }
